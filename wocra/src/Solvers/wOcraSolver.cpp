/**
 * \file wOcraSolver.cpp
 * \author Joseph Salini
 *
 * \brief Implement the internal solver class that can be used in the wOcra controller.
 */
 ...
 *
 */
wOcraSolver::wOcraSolver()
    : ocra::Solver()
    , ocra::NamedInstance("wOcra Solver")
{
 ...
 */
void wOcraSolver::printValuesAtSolution()
{
 ...
 * Actually does nothing.
 */
std::string wOcraSolver::toString() const
{
 ...
 */
void wOcraSolver::addObjective(ocra::QuadraticObjective& obj)
{
 ...
 */
void wOcraSolver::removeObjective(ocra::QuadraticObjective& obj)
{
 ...
 */
void wOcraSolver::addConstraint(ocra::LinearConstraint& constraint)
{
 ...
 */
void wOcraSolver::removeConstraint(ocra::LinearConstraint& constraint)
{
 ...
 *
 */
void wOcraSolver::prepareMatrices()
{
    Xsolution.resize(n());
}
 ...
 *  - solver_solve
 */
void wOcraSolver::writePerformanceInStream(std::ostream& outstream, bool addCommaAtEnd)
{
 ...
 *
 */
void wOcraSolver::reduceConstraints(const Eigen::MatrixXd& A, const Eigen::VectorXd& b, Eigen::MatrixXd& Ar, Eigen::VectorXd& br, double tolerance)
{
    if (A.rows()>0)
    {
