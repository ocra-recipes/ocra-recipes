 ...
 */
VariableWeightsTaskManager::VariableWeightsTaskManager(ocra::Controller& _ctrl,
...
VariableWeightsTaskManager::~VariableWeightsTaskManager()
{
 ...
 *
 */
void VariableWeightsTaskManager::_init(const Eigen::Vector3d& _taskPoint_LocalFrame, double _stiffness, double _damping, Eigen::Vector3d _weight)
{
    nDoF = 3;
    axes.resize(nDoF);
 ...
 */
void VariableWeightsTaskManager::setState(const Eigen::Vector3d& position)
{
 ...
 */
void VariableWeightsTaskManager::setState(const Eigen::Vector3d& position, const Eigen::Vector3d& velocity, const Eigen::Vector3d& acceleration)
{
 ...
 */
void VariableWeightsTaskManager::setWeights(Eigen::Vector3d weight)
{
    for (int i=0; i<nDoF; i++)
    {
 ...
 */
Eigen::VectorXd VariableWeightsTaskManager::getWeights()
{
 ...
 */
void VariableWeightsTaskManager::setStiffness(double stiffness)
{
    for (int i=0; i<nDoF; i++)
    {
 ...
 */
void VariableWeightsTaskManager::setDamping(double damping)
{
    for (int i=0; i<nDoF; i++)
    {
 ...
 *
 */
Eigen::VectorXd VariableWeightsTaskManager::getTaskError()
{
...
Eigen::Displacementd VariableWeightsTaskManager::getTaskFrameDisplacement()
{
    return featFrame->getPosition();
}

Eigen::Twistd VariableWeightsTaskManager::getTaskFrameVelocity()
{
    return featFrame->getVelocity();
}

Eigen::Twistd VariableWeightsTaskManager::getTaskFrameAcceleration()
{
    return featFrame->getAcceleration();
}

Eigen::Vector3d VariableWeightsTaskManager::getTaskFramePosition()
{
    return getTaskFrameDisplacement().getTranslation();
}

Eigen::Rotation3d VariableWeightsTaskManager::getTaskFrameOrientation()
{
    return getTaskFrameDisplacement().getRotation();
}

Eigen::Vector3d VariableWeightsTaskManager::getTaskFrameLinearVelocity()
{
    return getTaskFrameVelocity().getLinearVelocity();
}

Eigen::Vector3d VariableWeightsTaskManager::getTaskFrameAngularVelocity()
{
    return getTaskFrameVelocity().getAngularVelocity();
}

Eigen::Vector3d VariableWeightsTaskManager::getTaskFrameLinearAcceleration()
{
    return getTaskFrameAcceleration().getLinearVelocity();
}

Eigen::Vector3d VariableWeightsTaskManager::getTaskFrameAngularAcceleration()
{
