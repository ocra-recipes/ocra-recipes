...
namespace ocra
{
    ...
    bool TaskParser::addTaskManagersToSequence(ocra::Controller& ctrl, const ocra::Model& model, TaskSequence* sequence)
    {
    ...
    void TaskParser::prepareTaskManagerArguments(const ocra::Model& model, std::vector<taskManagerArgs>::iterator argStructPtr)
    {
