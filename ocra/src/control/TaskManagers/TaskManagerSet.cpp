...
namespace ocra
{
    ...
    void TaskManagerSet::init(ocra::Controller& ctrl, ocra::Model& model)
    {
        doInit(ctrl, model);
    }

    void TaskManagerSet::update(double time, ocra::Model& state, void** args)
    {
    ...
    bool TaskManagerSet::addTaskManager(std::string keyValue, std::shared_ptr<TaskManager> newTaskManager)
    {
    ...
    bool TaskManagerSet::removeTaskManager(std::string keyValue)
    {
        if (taskManagers.find(keyValue) != taskManagers.end()) {
    ...
    std::shared_ptr<TaskManager> TaskManagerSet::getTaskManagerPointer(std::string taskName)
    {
