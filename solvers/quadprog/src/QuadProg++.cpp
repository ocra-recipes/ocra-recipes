...
{
  /* ADDING SOME CODE:
   * Transpose the equality and inequiality matrices to pass from row-wise
   * matrices that are defined by default into Eigen, to get column-wise
   * matrix as required in QuadProg++.
   * Furthermore, copy _G into a temp object; Quadprog modify G during
   * optimization.
   */
